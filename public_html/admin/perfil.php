...
// Processar formulário (similar ao perfil do utilizador)
if (is_post()) {
      ...
      if (isset($_FILES['foto_perfil']) && $_FILES['foto_perfil']['error'] === UPLOAD_ERR_OK) {
            $uploaded = upload_image($_FILES['foto_perfil'], IMAGES_PATH . '/perfis', 'admin_');
            if ($uploaded) {
                  if ($foto_perfil)
...
<head>
      ...
      <title>Meu Perfil - Admin - Stand Automóvel SAW</title>
